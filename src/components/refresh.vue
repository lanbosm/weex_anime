<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        ...
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">前</text>
            <text ref="lTxt2" class="l-txt l-txt-2">端</text>
            <text ref="lTxt3" class="l-txt l-txt-3">真</text>
            <text ref="lTxt4" class="l-txt l-txt-4">苦</text>
            <text ref="lTxt5" class="l-txt l-txt-5">B</text>
